      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="relative">
          ...
          <motion.button
            ...
            className="absolute left-0 top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 bg-white border-2 border-orange-500 rounded-full flex items-center justify-center text-orange-500 hover:bg-orange-50 transition-all duration-300 shadow-lg hover:shadow-xl"
          ...
          <motion.button
            ...
            className="absolute right-0 top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 bg-white border-2 border-blue-500 rounded-full flex items-center justify-center text-blue-500 hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
          >
          ...
          <div className="overflow-hidden px-16">
            ...
            >
              ...
              {carouselItems.map((product, index) => (
                ...
                >
                  <div
                    className="bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-200 h-full hover:border-orange-300 hover:shadow-orange-100 transition-all duration-300 flex flex-col cursor-pointer"
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      {/* LEARN MORE button */}
                      <button className="text-orange-500 font-medium text-left hover:text-orange-600 transition-colors">
                        LEARN MORE
                      </button>
                    </div>
                  </div>
          ...
          >
            ...
            <div className="relative">
              <div className="h-64 md:h-80 relative overflow-hidden rounded-t-2xl">
                ...
                <button
                  onClick={closeModal}
                  className="absolute top-4 right-4 w-10 h-10 bg-white/90 rounded-full flex items-center justify-center text-gray-600 hover:text-gray-800 transition-colors"
                >
                  <svg
                    className="w-6 h-6"
                    fill="none"
